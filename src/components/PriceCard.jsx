...
export const PriceCard = () => {
  return (
    <div className='p-5'>
        <div className="w-10/12 m-auto space-y-2">
              <h1 className='text-6xl font-semibold text-center'>Simple, Transparent Pricing</h1>
...
<div className="card relative  bg-base-100  text-white scale-115 z-10 bg-gradient-to-r from-[#4f39f6] to-[#9514fa]  shadow-sm">
  <div className="card-body">
    <span className="badge absolute -top-2 left-30 badge-xs badge-warning">Most Popular</span>
    <div className="flex justify-between">
    ...
    <div className="mt-6">
      <button className="btn rounded-full btn-block">Subscribe</button>
    </div>
  </div>
</div>
<div className="card rounded-xl bg-base-100 shadow-sm">
  <div className="card-body">
    <span className="badge badge-xs badge-warning hidden">Most Popular</span>
    <div className="flex justify-between">
